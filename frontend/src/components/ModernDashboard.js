...
const ModernDashboard = ({ token, user, setToken }) => {
  ...
  const getStatusIcon = (status) => {
    switch(status) {
      case 'completed': return <CheckIcon sx={{ fontSize: 14, color: '#EF4444' }} />;
      ...
      <Container maxWidth="xl" sx={{ mt: -4, pb: 6 }}>
        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          <Grid item xs={12} sm={6} md={3}>
            <StatCard title="TOTAL COMPLAINTS" value={stats?.total_complaints || 0} icon={<CleanIcon />} color="#EF4444" delay={0} />
          </Grid>
          <Grid item xs={12} sm={6} md={3}>
                ...
                <CardContent>
                  ...
                  <ResponsiveContainer width="100%" height={350}>
                    <AreaChart data={trendData}>
                      ...
                      <Legend />
                      <Area type="monotone" dataKey="complaints" stroke="#EF4444" strokeWidth={2} fill="url(#complaintGradient)" name="New Complaints" />
                    ...
                    <TableBody>
                      {filteredComplaints.slice(0, 10).map((complaint, idx) => (
                        ...
                        >
                          ...
                          <TableCell>
                            <Chip label={complaint.complaint_type} size="small" sx={{ bgcolor: '#FEF2F2', color: '#DC2626' }} />
                          </TableCell>
                          <TableCell>
