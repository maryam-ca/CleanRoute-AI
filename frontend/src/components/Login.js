...
const Login = ({ setToken }) => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #F97316 0%, #EA580C 100%)', p: 2 }}>
      <Container maxWidth="sm">
        <Card sx={{ borderRadius: 4, overflow: 'hidden' }}>
          <Box sx={{ bgcolor: '#F97316', color: 'white', p: 3, textAlign: 'center' }}>
          ...
          <CardContent sx={{ p: 3 }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <Button 
                ...
                variant="contained" 
                disabled={loading} 
                sx={{ mt: 3, py: 1.5, bgcolor: '#F97316', '&:hover': { bgcolor: '#EA580C' } }}
              >
